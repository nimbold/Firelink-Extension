const POPUP_LOCALES = Object.freeze({
  en: {
    ...
    discovering: "Checking this tab for media...",
  ...
  he: {
    ...
    discovering: "בודק אם יש מדיה בכרטיסייה...",
  ...
  fa: {
    ...
    discovering: "در حال بررسی رسانه در این زبانه...",
  ...
  uk: {
    ...
    discovering: "Пошук медіа на цій вкладці...",
  ...
  ru: {
    ...
    discovering: "Поиск медиа на этой вкладке...",
